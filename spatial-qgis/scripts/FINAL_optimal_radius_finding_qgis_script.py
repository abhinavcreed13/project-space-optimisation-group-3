...
class ClusteringAlgo(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterString(
                self.PLOT_PATH,
                'Enter directory for storing plot',
                defaultValue="/"
            )
        )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        plot_path = self.parameterAsString(
            parameters,
            self.PLOT_PATH,
            context
        )
        ...
        obj.KMEANS(df,scatter_plot_enabled, plot_path)
...
class Cluster():
    ...
    def KMEANS(self,data,scatter_plot_enabled, plot_path):
        plt.clf()
        X = data.to_numpy()
